...
import DoctorProfileCompletion from "../../middleware/DoctorProfileCompletion";
...
const profileCompletion = function () {
    ...
    return(
        <div>
            ...
            { context.loaded && (<DoctorRegistration/>)}
            {/*{ <DoctorRegistration/> }*/}
        </div>
    );
};

export default DoctorProfileCompletion(profileCompletion);